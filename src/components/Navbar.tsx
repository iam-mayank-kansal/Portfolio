...
const DATA = {
    ...
    contact: {
        social: {
            GitHub: {
                name: "GitHub",
                url: "https://github.com/iam-mayank-kansal",
                icon: Icons.github,
            },
            LinkedIn: {
                name: "LinkedIn",
                url: "https://www.linkedin.com/in/mayank-kansal-a062752a7/",
                icon: Icons.linkedin,
            },
            X: {
                name: "X",
                url: "https://x.com/_mayankkansal_",
                icon: Icons.x,
            },
            email: {
                name: "Send Email",
                url: "mailto:iam.mayank.kansal.01@gmail.com",
                icon: Icons.email,
            },
        },
    },
